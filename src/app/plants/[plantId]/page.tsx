...
export default function Plant({ params }: { params: { plantId: string } }) {
  ...
  const [date, setDate] = useState(getDate());
    ...
    return <div className="border-t-2 mt-6 ">
          ...
          <div className="flex flex-row gap-16 justify-center items-center m-4">
            {/* image */}
               <div className="flex flex-col gap-7 justify-center items-center">
                    ...
                    <div className=" bg-green-400 rounded-xl px-9 py-3 text-xl text-white font-bold">Cây chuối</div>
               </div>
