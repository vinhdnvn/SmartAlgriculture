...
const TrackingList: React.FC<TrackingListProps> = (
    ...
    return (
        <div onClick={() => {
        ...
        }} className={cn("w-[90%] cursor-pointer   px-5 py-6 flex flex-row", haveDiseasePlant ? "bg-red-400" : "")}>
                  ...
                  "
                            ...
                            <div className="flex flex-row justify-between gap-10 items-center">
                                ...
                                <div className="flex flex-col justify-center items-start gap-8">
                                    ...
                                    <button key="id" onClick={()=> setIsDetectModalOpen(true)}  className="bg-orange-300 rounded-xl px-14 text-xl font-medium cursor-pointer transition duration-150 hover:bg-green-300 py-4 flex items-center justify-center ">Trợ giúp cây trồng </button>
            ...
            {/* detect modal */}
            <Transition.Root show={isDetectModalOpen} as={Fragment} >
                <Dialog as="div" className="fixed inset-0 flex w-screen ml-20 items-center justify-center p-4  " onClose={() => setIsModalOpen(false)} >
                    <Transition.Child
                        as={Fragment}
                        enter="ease-out duration-300"
